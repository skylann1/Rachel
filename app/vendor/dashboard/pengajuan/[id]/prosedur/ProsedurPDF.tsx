...
const styles = StyleSheet.create({
  ...
  table: {
    ...
    borderLeftWidth: 1,
    borderColor: '#000',
    flex: 1, // Fill available page space
  },
  tableRow: {
    flexDirection: 'row',
  },
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            ...
            <View style={[styles.cell, styles.row2Col2]}><Text style={{ fontSize: 8, textAlign: 'center' }}>{data.docNo || '-'}</Text></View>
            <View style={[styles.cell, styles.row2Col3]}><Text style={styles.textCenter}>Contract No.</Text></View>
            <View style={[styles.cell, styles.row2Col4]}><Text style={{ fontSize: 8, textAlign: 'center' }}>{data.contractNo}</Text></View>
            <View style={[styles.cell, styles.row2Col5]}><Text style={styles.textCenter}>Date</Text></View>
            <View style={[styles.cell, styles.row2Col6]}><Text style={{ fontSize: 8, textAlign: 'center' }}>{data.submissionDate}</Text></View>
          </View>
          ...
          <View style={styles.tableRow}>
            <View style={[styles.cell, styles.revCol1]}>
              <Text style={styles.textBoldCenter}>REV.</Text>
            </View>
            <View style={[styles.cell, styles.revCol2]}>
              <Text style={styles.textBoldCenter}>DESCRIPTION</Text>
            </View>
            <View style={{ width: '60%', flexDirection: 'column' }}>
              <View style={{ flexDirection: 'row' }}>
                <View style={[styles.cell, { width: '25%' }]}><Text style={styles.textBoldCenter}>BY</Text></View>
                <View style={[styles.cell, { width: '25%' }]}><Text style={styles.textBoldCenter}>CHKD</Text></View>
                <View style={[styles.cell, { width: '25%' }]}><Text style={styles.textBoldCenter}>APVD</Text></View>
                <View style={[styles.cell, { width: '25%' }]}><Text style={styles.textBoldCenter}>APVD</Text></View>
              </View>
              <View style={{ flexDirection: 'row' }}>
                <View style={[styles.cell, { width: '75%' }]}><Text style={styles.textBoldCenter}>PT. PGAS Solution</Text></View>
                <View style={[styles.cell, { width: '25%' }]}><Text style={styles.textBoldCenter}>PGN</Text></View>
              </View>
            </View>
          </View>
        </View>
