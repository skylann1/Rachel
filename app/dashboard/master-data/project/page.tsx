            ...
            <div className="flex-1 flex gap-5">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  <span className="text-xs font-bold text-slate-500 bg-slate-100 px-2.5 py-0.5 rounded-lg">{project.id}</span>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="w-full bg-slate-100 rounded-full h-2">
                    <div 
                      className={`h-2 rounded-full ${project.progress === 100 ? 'bg-emerald-500' : 'bg-primary'}`}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl w-full max-w-2xl flex flex-col shadow-2xl animate-in zoom-in-95 duration-200">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary/30 focus:border-primary outline-none transition-all text-sm">
                    ...
                    <option>Stasiun Muara Bekasi</option>
                    <option>Plant A, Zona Merah</option>
                    <option>Stasiun Kompresor B</option>
                    <option>Jalur Distribusi C</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-primary/30 focus:border-primary outline-none transition-all text-sm">
                    ...
                    <option>CV. JAYA PUTRA BAHARI</option>
                    <option>PT. Konstruksi Sejahtera</option>
                    <option>CV. Teknik Mesin Nusantara</option>
                    <option>PT. Bangun Graha</option>
                  </select>
                </div>
            ...
            <div className="p-6 border-t border-slate-100 bg-slate-50/50 rounded-b-2xl flex justify-end gap-3">
              ...
              <button 
                onClick={() => setIsModalOpen(false)}
                className="px-5 py-2.5 text-sm font-bold text-white bg-primary hover:bg-primary/90 rounded-xl transition-colors shadow-sm shadow-primary/30"
              >
                Simpan Proyek
              </button>
            </div>
